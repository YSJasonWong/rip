...
<body class="bg-1 font-1">
    ...
    <div class="container-fluid">
        <div class="row vh-100 align-items-center justify-content-center">
            <div class="col-9">
                <h2 class="fs-2">Your profile has been saved.<br>Thank you for your Support! Please click <a class="btn fs-2 bg-black text-1" href="infoEn.php">here</a> to review your profile.</h2>
            </div>
        </div>
    </div>
